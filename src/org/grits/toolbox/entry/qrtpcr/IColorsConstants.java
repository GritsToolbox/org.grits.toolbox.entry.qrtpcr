...
public interface IColorsConstants {
    static final RGB[] COLORS = new RGB[] {new RGB(0, 0, 0), new RGB(255, 0, 0),  new RGB(128, 128, 128), new RGB(0, 0, 255), new RGB(0, 255, 0),
            new RGB(255, 255, 0), new RGB(255, 0, 255), new RGB(0, 255, 255), new RGB(255, 255, 255),
            new RGB(0, 100, 205), new RGB(100, 205, 0), new RGB(205, 0, 100),  new RGB(100, 255, 255),
