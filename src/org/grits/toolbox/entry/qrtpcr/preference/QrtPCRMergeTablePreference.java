...
@XmlRootElement(name="qrtPCRMergePreference")
public class QrtPCRMergeTablePreference extends QrtPCRPreference {

	private static final String MERGE_PREFERENCE_NAME_ALL = "org.grits.toolbox.display.control.table.preference.QrtPCRMergeTablePreference";
	private static final String CURRENT_VERSION = "1.0";

	protected String getCurrentVersion() {
		return QrtPCRMergeTablePreference.CURRENT_VERSION;
	}
	
	public static String getPreferenceID() {
		return MERGE_PREFERENCE_NAME_ALL;
	}
